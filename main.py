...
if __name__ == '__main__':
    ...
    print('- Local search followed by Bosman paper:', bool(args.followed_bosman_paper))
    print('*' * 40)
    print()
    ...
    for i_run in range(args.number_of_runs):
        seed = args.seed + i_run * 100
        np.random.seed(seed)
        ...
        if args.save == 1:
            ...
            # Open file log
            logfile = open(sub_path + '/log_fife.txt', 'w')
